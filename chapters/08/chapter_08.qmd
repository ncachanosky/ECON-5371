---
title: "Chapter 8: Cointegration and the Vector Error Correction Model"
author: ""
abstract: |
...
gs10_raw = web.DataReader("GS10", "fred", start, end)
gs10_raw.columns = ["GS10"]

# ── 3-month Treasury bill rate (TB3MS, monthly) ───────────────────────────────
tb3_raw = web.DataReader("TB3MS", "fred", start, end)
...
1954Q1 through 2019Q4, constructed from FRED series GS10 and TB3MS, resampled
...
inversion** — the period when the spread crosses zero from above, shaded in
terracotta. In the VECM framework, an inversion means the error correction
...
This is the essence of cointegration: the non-stationarity in both series comes
...
The expectations hypothesis of the term structure (EH) is one of the oldest
...
The Johansen procedure begins not with a new model but with the VAR in levels
