...
ses_low  = SimpleExpSmoothing(series_fit, initialization_method="estimated").fit(smoothing_level=0.05, optimized=False)
ses_high = SimpleExpSmoothing(series_fit, initialization_method="estimated").fit(smoothing_level=0.4,  optimized=False)

# Holt (undamped and damped)
holt_und  = Holt(series_fit, initialization_method="estimated").fit(optimized=True)
holt_dmp  = Holt(series_fit, damped_trend=True, initialization_method="estimated").fit(optimized=True)
